...
class PlaceFeedbackDialog extends StatefulWidget {
  const PlaceFeedbackDialog(
      {super.key, required this.placeId, required this.communityRepository});
  final int placeId;
...
class _PlaceFeedbackDialogState extends State<PlaceFeedbackDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await widget.communityRepository.submitFeedback(
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('شكراً لمشاركتك! سيتم مراجعة رأيك ونشره.')));
      }
    } catch (e) {
      if (mounted)
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: AlertDialog(
        ...
        title: const Text('ما رأيك في هذا المكان؟',
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: InputDecoration(
                  labelText: 'اكتب ملاحظتك عن المكان...',
