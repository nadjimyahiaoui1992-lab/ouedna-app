      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _buildSection('مقدمة',
                  'نحن في تطبيق "وادنا" نلتزم بحماية خصوصيتك وبياناتك الشخصية. توضح هذه السياسة كيفية جمع واستخدام وحماية المعلومات التي تقدمها لنا.'),
              _buildSection('المعلومات التي نجمعها',
                  '• الموقع الجغرافي: نطلب الوصول إليه فقط عند ضغطك على زر تحديد الموقع للملاحة أو عند اختيار مشاركة موقع الضحية في الطوارئ.\n• الصور: نطلب الوصول للمعرض فقط في حال رغبتك في اقتراح معلم جديد أو مشاركة تجربة سياحية.\n• ملفات التحديث: في الإصدار المباشر خارج المتجر فقط، قد ينزّل التطبيق ملف تحديث APK موثّقاً بعد طلبك الصريح.'),
              _buildSection('كيفية استخدام المعلومات',
                  'تُستخدم بيانات الموقع محلياً على جهازك ولا يتم تخزينها في خوادمنا لأغراض التتبع. عند اختيار مشاركة الموقع في حالة طارئة، يفتح التطبيق واجهة المشاركة التي تختارها أنت. الصور والمقترحات التي ترسلها يتم مراجعتها من قبل الإدارة قبل النشر لضمان جودة المحتوى.'),
