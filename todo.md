...
- [ ] Ajouter le support des dates documentées et des galeries d’images dans l’archive visiteur.
- [ ] Mettre à jour la version Android et vérifier les autorisations réellement utilisées.
